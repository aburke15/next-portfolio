        ...
        <div className="global-margin">
          <div className="row">
            <div className="col-md-4">
              <Image src={csharp} alt="CSharp Programming" height={175} width={175} />
              <h3>C#</h3>
            </div>
            <div className="col-md-4">
            ...
            <div className="col-md-4">
              <Image src={git} alt="Git Version Control" height={175} width={175} />
              <h3>Git VCS</h3>
            </div>
          </div>
          {/* Second Skill Row */}
          <div className="row mt-5">
            <div className="col-md-4">
              <Image src={netCore} alt="ASP.NET Core" height={175} width={275} />
              <h3>ASP.NET Core</h3>
            </div>
            <div className="col-md-4">
            ...
            <div className="col-md-4">
              <Image src={efCore} alt="Entity Framework Core" height={175} width={275} />
              <h3>EF Core</h3>
            </div>
          </div>
          {/* Third Skill Row */}
          <div className="row mt-5">
            <div className="col-md-4">
              <Image className="skill-icon" src={html} alt="HTML Five" height={175} width={175} />
              <h3>HTML5</h3>
            </div>
            <div className="col-md-4">
              <Image src={ts} alt="TypeScript Programming" height={175} width={175} />
              <h3>TypeScript</h3>
            </div>
            <div className="col-md-4">
